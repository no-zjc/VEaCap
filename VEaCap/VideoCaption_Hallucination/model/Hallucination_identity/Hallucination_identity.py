...
# annotations_path = ["/home/wy3/zjc_data/datasets/MSVD-QA/msvd_hallucination_dataset_sv_ls.json",
#                     "/home/wy3/zjc_data/datasets/MSR-VTT/msrvtt_hallucination_dataset_sv_ls.json"]

annotations_path = ["/home/wy3/zjc_data/datasets/MSVD-QA/msvd_hallucination_dataset_sv_ls_gpt_finals.json",
                    "/home/wy3/zjc_data/datasets/MSR-VTT/msrvtt_hallucination_dataset_sv_ls_gpt_finals.json"]


model_name = dataset_type[dt] + '_hallucination_identity_gpt_' + gen_type + '.pt'
...
class HallucinationIdentityModel(nn.Module):
    def __init__(self, input_size, hidden_size, num_classes):
        ...
        self.mlp_layer1 = nn.Linear(hidden_size, int(hidden_size/2))
        self.mlp_layer2 = nn.Linear(int(hidden_size/2), int(hidden_size/8))
        self.output_layer = nn.Linear(int(hidden_size/8), num_classes)
...
def train_model():
    ...
    for epoch in range(num_epochs):
        ...
        print('Epoch [{}/{}], Loss: {:.4f}, acc: {}, best_epoch:{}, best_acc: {}'.format(epoch + 1, num_epochs, loss.item(), acc["acc"], best_epoch, best_acc))

    File_Tools.write_to_json(dataset_type[0] + '_hallucination_identity_' + gen_type + '.json', {"model_name": model_name, "acc": best_acc, "best_epoch": best_epoch})
