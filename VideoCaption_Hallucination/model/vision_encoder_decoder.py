...
# from transformers import LogitsProcessorList, StoppingCriteriaList, Constraint, PreTrainedModel
if HC_label == 0:
    from transformers import PreTrainedModel
if HC_label == 1:
    from VideoCaption_Hallucination.model.modeling_utils import PreTrainedModel
...
from VideoCaption_Hallucination.model.gpt2 import ThisGPT2LMHeadModel
from VideoCaption_Hallucination.model.gpt2 import ThisGPT2Config
    ...
    def from_encoder_decoder_pretrained(
        ...
        **kwargs
        ...
        if decoder is None:
            ...
            decoder.config.cross_attention_hidden_size = 512
